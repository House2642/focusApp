...
export default function App() {
  ...
  if (state.screen === 'curious') return <CuriousScreen messages={state.messages} questionIndex={state.questionIndex} isLoading={state.isLoading} error={state.error} submitAnswer={state.submitAnswer} />
